...
# 第1部分：宏观意愿题（11题）
#
# 所有 industry_weights 的键都是**33 个细粒度产业方向**（INDUSTRY_DIMENSIONS），
# 与专业类的 industry_map 标签使用同一套词表——不再经过任何多对一压缩。
# 历史版本这里只有 10 个粗产业集群，压缩导致「政府公共」覆盖 53.8% 的专业类、
# 「物流管理与工程类」凭空继承热门集群等问题，详见 user_profile.INDUSTRY_DIMENSIONS。
#
# 权重写法的约定：每题各选项的 industry_weights 之和 ≈ 1.0，只列该选项**真正指向**
# 的方向（不为了凑满 33 维而摊薄），因为归一化是「按每维自身上限」做的，摊薄只会
# 让所有维度互相稀释。
# ============================================================================
...
MACRO_QUESTIONS = [
    # ---- M1：身份认同 ----
    {
        ...
        "options": {
            "A": {
                "text": "创办了一家有影响力的公司",
                "industry_weights": {"互联网/软件": 0.25, "人工智能/大模型": 0.20, "金融/银行": 0.15,
                                     "证券/基金/资管": 0.15, "智能制造/机器人": 0.15, "零售/电商/消费": 0.10},
                "value_weights": {"经济回报": 0.7, "社会影响力": 0.3},
            },
            "B": {
                "text": "在某个技术领域做到了顶尖水平",
                "industry_weights": {"人工智能/大模型": 0.35, "半导体/集成电路": 0.30,
                                     "智能制造/机器人": 0.15, "科研/学术": 0.10, "能源/电力/碳中和": 0.10},
                "value_weights": {"成长导向": 0.6, "社会影响力": 0.4},
            },
            "C": {
                "text": "帮助了很多人，改变了他们的生活",
                "industry_weights": {"教育培训": 0.30, "医疗健康/临床": 0.25, "政府/公共服务": 0.20,
                                     "制药/生物技术": 0.15, "法律服务/合规": 0.10},
                "value_weights": {"社会影响力": 0.8, "稳定偏好": 0.2},
            },
            "D": {
                "text": "创作了打动人心的作品",
                "industry_weights": {"影视/动画/娱乐": 0.30, "传媒/广告/公关": 0.25, "艺术设计/文创": 0.25,
    ...
    # ---- M2：自由时间偏好 ----
    {
        ...
        "options": {
            "A": {
                ...
                "industry_weights": {"人工智能/大模型": 0.25, "互联网/软件": 0.25, "半导体/集成电路": 0.20,
                                     "智能制造/机器人": 0.20, "通信/5G/6G": 0.10},
                "value_weights": {"成长导向": 0.8, "经济回报": 0.2},
            },
            "B": {
                "text": "读一堆书并写详细的读书笔记",
                "industry_weights": {"教育培训": 0.35, "科研/学术": 0.25, "政府/公共服务": 0.20,
                                     "传媒/广告/公关": 0.20},
                "value_weights": {"成长导向": 0.6, "稳定偏好": 0.4},
            },
            "C": {
                "text": "组织朋友做一个社区公益或商业小项目",
                "industry_weights": {"教育培训": 0.20, "互联网/软件": 0.15, "金融/银行": 0.15,
                                     "证券/基金/资管": 0.15, "政府/公共服务": 0.15,
                                     "传媒/广告/公关": 0.10, "零售/电商/消费": 0.10},
    ...
    # ---- M3：问题解决偏好 ----
    {
        ...
        "options": {
            "A": {
                ...
                "industry_weights": {"人工智能/大模型": 0.25, "半导体/集成电路": 0.20, "智能制造/机器人": 0.20,
                                     "互联网/软件": 0.15, "新能源汽车": 0.10, "能源/电力/碳中和": 0.10},
                "value_weights": {"成长导向": 0.7, "经济回报": 0.3},
            },
            "B": {
                "text": "人的问题——比如帮朋友化解矛盾、让团队更团结",
                "industry_weights": {"教育培训": 0.30, "政府/公共服务": 0.25, "医疗健康/临床": 0.15,
                                     "法律服务/合规": 0.15, "传媒/广告/公关": 0.15},
                "value_weights": {"社会影响力": 0.8, "稳定偏好": 0.2},
            },
            "C": {
                "text": "策略问题——比如怎么让一个活动更成功、生意更赚钱",
                "industry_weights": {"互联网/软件": 0.20, "金融/银行": 0.20, "证券/基金/资管": 0.15,
                                     "咨询/审计/税务": 0.15, "零售/电商/消费": 0.10,
                                     "智能制造/机器人": 0.10, "能源/电力/碳中和": 0.10},
                "value_weights": {"经济回报": 0.6, "社会影响力": 0.4},
            },
            "D": {
                "text": "知识问题——比如搞清楚一个自然现象的深层原因",
                "industry_weights": {"科研/学术": 0.25, "医疗健康/临床": 0.15, "制药/生物技术": 0.15,
                                     "人工智能/大模型": 0.15, "能源/电力/碳中和": 0.10,
    ...
    # ---- M4：职业崇拜 ----
    {
        ...
        "options": {
            "A": {
                ...
                "industry_weights": {"人工智能/大模型": 0.35, "半导体/集成电路": 0.25, "航空航天": 0.15,
                                     "智能制造/机器人": 0.15, "能源/电力/碳中和": 0.10},
                "value_weights": {"成长导向": 0.6, "社会影响力": 0.2, "经济回报": 0.2},
            },
            "B": {
                "text": "外科医生、救援队长或无国界医生",
                "industry_weights": {"医疗健康/临床": 0.50, "政府/公共服务": 0.25,
                                     "制药/生物技术": 0.15, "军事/国防工业": 0.10},
                "value_weights": {"社会影响力": 0.7, "稳定偏好": 0.3},
            },
            "C": {
                "text": "投资人、创业者或顶级律师",
                "industry_weights": {"金融/银行": 0.25, "证券/基金/资管": 0.25, "法律服务/合规": 0.20,
                                     "咨询/审计/税务": 0.15, "互联网/软件": 0.15},
                "value_weights": {"经济回报": 0.6, "社会影响力": 0.4},
            },
            "D": {
                "text": "导演、作家或独立音乐人",
    ...
    # ---- M5：成就感来源 ----
    {
        ...
        "options": {
            "A": {
                "text": "看到自己做的产品被很多人使用",
                "industry_weights": {"互联网/软件": 0.30, "人工智能/大模型": 0.25, "智能制造/机器人": 0.15,
                                     "零售/电商/消费": 0.15, "新能源汽车": 0.08, "通信/5G/6G": 0.07},
                "value_weights": {"社会影响力": 0.5, "经济回报": 0.3, "成长导向": 0.2},
            },
            "B": {
                "text": "攻克了一个困扰很久的技术或理论难题",
                "industry_weights": {"人工智能/大模型": 0.25, "半导体/集成电路": 0.25, "科研/学术": 0.15,
                                     "医疗健康/临床": 0.10, "制药/生物技术": 0.10,
                                     "新能源汽车": 0.08, "能源/电力/碳中和": 0.07},
                "value_weights": {"成长导向": 0.8, "社会影响力": 0.2},
            },
            "C": {
                "text": "学生/病人/客户因为你而变得更好",
                "industry_weights": {"教育培训": 0.40, "医疗健康/临床": 0.25, "政府/公共服务": 0.15,
                                     "制药/生物技术": 0.10, "法律服务/合规": 0.10},
                "value_weights": {"社会影响力": 0.8, "稳定偏好": 0.2},
            },
            "D": {
                "text": "自己的作品被人欣赏和记住",
    ...
    # ---- M6：风险态度 ----
    {
        ...
        "options": {
            "A": {
                ...
                "industry_weights": {"政府/公共服务": 0.35, "教育培训": 0.25, "能源/电力/碳中和": 0.15,
                                     "金融/银行": 0.15, "医疗健康/临床": 0.10},
                "value_weights": {"稳定偏好": 0.9, "社会影响力": 0.1},
            },
            "B": {
                "text": "适度不确定性可以接受，但要有基本保障",
                "industry_weights": {"金融/银行": 0.15, "智能制造/机器人": 0.15, "教育培训": 0.13,
                                     "医疗健康/临床": 0.12, "制药/生物技术": 0.10, "新能源汽车": 0.10,
                                     "能源/电力/碳中和": 0.10, "通信/5G/6G": 0.10, "建筑/土木/城规": 0.05},
                "value_weights": {"稳定偏好": 0.4, "风险容忍度": 0.3, "成长导向": 0.3},
            },
            "C": {
                "text": "稳定不是首要考虑，成长空间更重要",
                "industry_weights": {"互联网/软件": 0.25, "人工智能/大模型": 0.25, "金融/银行": 0.10,
                                     "证券/基金/资管": 0.10, "新能源汽车": 0.10,
                                     "能源/电力/碳中和": 0.10, "半导体/集成电路": 0.10},
                "value_weights": {"成长导向": 0.7, "风险容忍度": 0.3},
            },
            "D": {
                "text": "喜欢高风险高回报的节奏",
                "industry_weights": {"证券/基金/资管": 0.30, "金融/银行": 0.20, "互联网/软件": 0.20,
    ...
    # ---- M7：大学目标 ----
    {
        ...
        "options": {
            "A": {
                "text": "过硬的专业硬技能，毕业即高薪",
                "industry_weights": {"人工智能/大模型": 0.25, "互联网/软件": 0.25, "半导体/集成电路": 0.20,
                                     "金融/银行": 0.15, "通信/5G/6G": 0.15},
                "value_weights": {"经济回报": 0.7, "成长导向": 0.3},
            },
            "B": {
                "text": "深厚的理论功底，为读研读博打基础",
                "industry_weights": {"科研/学术": 0.25, "人工智能/大模型": 0.15, "半导体/集成电路": 0.15,
                                     "医疗健康/临床": 0.10, "制药/生物技术": 0.10,
                                     "能源/电力/碳中和": 0.10, "教育培训": 0.10, "测绘/地质/矿业": 0.05},
                "value_weights": {"成长导向": 0.8, "稳定偏好": 0.2},
            },
            "C": {
                "text": "广泛的人脉和综合能力，未来做什么都行",
                "industry_weights": {"政府/公共服务": 0.25, "教育培训": 0.20, "金融/银行": 0.15,
                                     "咨询/审计/税务": 0.15, "互联网/软件": 0.15, "法律服务/合规": 0.10},
                "value_weights": {"社会影响力": 0.5, "经济回报": 0.3, "风险容忍度": 0.2},
            },
            "D": {
                "text": "找到自己真正热爱的事业方向",
                "industry_weights": {"教育培训": 0.25, "传媒/广告/公关": 0.20, "艺术设计/文创": 0.15,
    ...
    # ---- M8：工作节奏 ----
    {
        ...
        "options": {
            "A": {
                ...
                "industry_weights": {"人工智能/大模型": 0.25, "互联网/软件": 0.25, "证券/基金/资管": 0.20,
                                     "金融/银行": 0.20, "咨询/审计/税务": 0.10},
            ...
            "C": {
                ...
                "industry_weights": {"智能制造/机器人": 0.20, "半导体/集成电路": 0.15, "传媒/广告/公关": 0.13,
                                     "新能源汽车": 0.12, "能源/电力/碳中和": 0.12,
                                     "建筑/土木/城规": 0.12, "航空航天": 0.08, "石油/化工/材料": 0.08},
    ...
    # ---- M9：深耕领域 ----
    {
        ...
        "options": {
            "A": {
                "text": "计算机、AI或电子硬件",
                "industry_weights": {"人工智能/大模型": 0.30, "互联网/软件": 0.25, "半导体/集成电路": 0.25,
                                     "通信/5G/6G": 0.10, "智能制造/机器人": 0.10},
                "value_weights": {"经济回报": 0.5, "成长导向": 0.5},
            },
            "B": {
                "text": "医学、生物学或化学",
                "industry_weights": {"医疗健康/临床": 0.35, "制药/生物技术": 0.30, "科研/学术": 0.15,
                                     "石油/化工/材料": 0.10, "农业/食品/林业": 0.10},
                "value_weights": {"社会影响力": 0.6, "成长导向": 0.3, "稳定偏好": 0.1},
            },
            "C": {
                "text": "金融、经济或法律",
                "industry_weights": {"金融/银行": 0.25, "法律服务/合规": 0.20, "证券/基金/资管": 0.15,
                                     "保险/精算": 0.10, "咨询/审计/税务": 0.10,
                                     "政府/公共服务": 0.10, "互联网/软件": 0.10},
                "value_weights": {"经济回报": 0.6, "社会影响力": 0.4},
            },
            "D": {
                "text": "物理、数学或基础研究",
                "industry_weights": {"科研/学术": 0.25, "半导体/集成电路": 0.20, "人工智能/大模型": 0.15,
                                     "能源/电力/碳中和": 0.10, "航空航天": 0.10, "智能制造/机器人": 0.10,
                                     "测绘/地质/矿业": 0.10},
                "value_weights": {"成长导向": 0.8, "社会影响力": 0.2},
            },
            "E": {
                "text": "教育、心理或社会工作",
                "industry_weights": {"教育培训": 0.45, "政府/公共服务": 0.20, "法律服务/合规": 0.15,
    ...
    # ---- M10：敬佩对象 ----
    {
        ...
        "options": {
            "A": {
                "text": "攻克技术难题的工程师或科学家",
                "industry_weights": {"人工智能/大模型": 0.20, "半导体/集成电路": 0.20, "科研/学术": 0.15,
                                     "智能制造/机器人": 0.15, "航空航天": 0.10,
                                     "新能源汽车": 0.10, "能源/电力/碳中和": 0.10},
                "value_weights": {"成长导向": 0.7, "社会影响力": 0.3},
            },
            "B": {
                "text": "救死扶伤的医生或冲在一线的记者",
                "industry_weights": {"医疗健康/临床": 0.40, "传媒/广告/公关": 0.25,
                                     "政府/公共服务": 0.20, "制药/生物技术": 0.15},
                "value_weights": {"社会影响力": 0.8, "风险容忍度": 0.2},
            },
            "C": {
                "text": "白手起家的企业家或顶级投资人",
                "industry_weights": {"证券/基金/资管": 0.25, "金融/银行": 0.20, "互联网/软件": 0.20,
                                     "人工智能/大模型": 0.15, "零售/电商/消费": 0.10,
                                     "咨询/审计/税务": 0.10},
                "value_weights": {"经济回报": 0.6, "风险容忍度": 0.4},
            },
            "D": {
    ...
    # ---- M11：具体行业方向 ----
    #
    # 为什么必须有这一题：前 10 题问的都是「你想成为什么样的人」，再间接推行业，
    # 覆盖面天然偏向科技/金融/文教/医疗。建筑、物流、航空航天、海洋工程、农业、
    # 地质、体育、旅游、房地产这些方向**一道题都问不到**——归一化是按「每维自身上限」
    # 做的，没人能表达的维度恒为 0，于是这些专业类的产业匹配对所有用户都是 0
    # （或被错误地并入「智能制造」之类的大集群，反而凭空得分）。
    # 这一题直接问，把它们变成可表达的。
    #
    # 注意选项 G：如果逼所有人从 A-F 里选，本没有这些意向的用户会被注入假信号。
    # G 不携带任何产业权重，等价于「这一题我没意见」。
    {
        "id": "M11",
        "question": "如果必须选一个更具体的行业方向，你更愿意去？",
        "options": {
            "A": {
                "text": "建筑、土木工程、城市规划或房地产",
                "industry_weights": {"建筑/土木/城规": 0.55, "房地产/物业": 0.45},
                "value_weights": {"稳定偏好": 0.4, "经济回报": 0.3, "成长导向": 0.3},
            },
            "B": {
                "text": "物流、供应链、交通运输或电商零售",
                "industry_weights": {"物流/供应链": 0.55, "零售/电商/消费": 0.30, "互联网/软件": 0.15},
                "value_weights": {"经济回报": 0.5, "稳定偏好": 0.3, "成长导向": 0.2},
            },
            "C": {
                "text": "航空航天、船舶海洋或国防军工",
                "industry_weights": {"航空航天": 0.40, "海洋工程/船舶": 0.30, "军事/国防工业": 0.20,
                                     "智能制造/机器人": 0.10},
                "value_weights": {"稳定偏好": 0.5, "社会影响力": 0.3, "成长导向": 0.2},
            },
            "D": {
                "text": "农业、食品、林业或环保",
                "industry_weights": {"农业/食品/林业": 0.55, "环保/新能源": 0.30, "制药/生物技术": 0.15},
                "value_weights": {"社会影响力": 0.5, "稳定偏好": 0.3, "成长导向": 0.2},
            },
            "E": {
                "text": "能源电力、地质测绘或矿业",
                "industry_weights": {"能源/电力/碳中和": 0.35, "测绘/地质/矿业": 0.35,
                                     "石油/化工/材料": 0.20, "环保/新能源": 0.10},
                "value_weights": {"稳定偏好": 0.5, "经济回报": 0.3, "成长导向": 0.2},
            },
            "F": {
                "text": "体育、旅游、酒店或会展",
                "industry_weights": {"体育产业": 0.45, "旅游/酒店/会展": 0.45, "传媒/广告/公关": 0.10},
                "value_weights": {"社会影响力": 0.4, "成长导向": 0.4, "风险容忍度": 0.2},
            },
            "G": {
                "text": "以上都不是，我更想去前面那些主流方向",
                "industry_weights": {},
                "value_weights": {"成长导向": 0.5, "稳定偏好": 0.5},
            },
        },
    },
]
...
def score_macro_questions(answers: dict[str, str]) -> tuple[dict[str, float], dict[str, float]]:
    ...
    industry_max = {ind: 0.0 for ind in INDUSTRY_DIMENSIONS}
